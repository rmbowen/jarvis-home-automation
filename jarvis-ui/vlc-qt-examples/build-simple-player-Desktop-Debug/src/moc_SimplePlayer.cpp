...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SimplePlayer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 70, 10)
    ...
    "on_btnSwitch_clicked\0socketConnection\0"
    "socketData\0"
};
...
void SimplePlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_btnSwitch_clicked(); break;
        case 3: _t->socketConnection(); break;
        case 4: _t->socketData(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject SimplePlayer::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_SimplePlayer.data,
      qt_meta_data_SimplePlayer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SimplePlayer.stringdata))
